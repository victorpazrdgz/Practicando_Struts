...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
     ...
     <br /> 
     <br /> 
     <!-- Carga el archivo pdf en pantalla -->
     <center><object data="jsp/files/Memoria.pdf" width="900" height="1200" type="application/pdf"></object></center>
  </body>
</html>